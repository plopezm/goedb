...
func GetSQLDialectInstance() (dialect *SQLDialect) {
	dialect = new(SQLDialect)
	dialect.Models = make(map[string]Table)
	return dialect
}

func (dialect *SQLDialect) GetModel(name string) (Table, bool) {
	model, ok := dialect.Models[name]
	return model, ok
}

func (dialect *SQLDialect) SetModel(name string, table Table) {
...
func (dialect *SQLDialect) Create(table Table) string {
	columns := ""
	pksFound := ""
	constraints := ""
...
func (dialect *SQLDialect) Insert(table Table, instance interface{}) (string, error) {
...
func (dialect *SQLDialect) First(table Table, where string, instance interface{}) (string, error) {
...
func (dialect *SQLDialect) Find(table Table, where string, instance interface{}) (string, error) {
...
func (dialect *SQLDialect) Update(table Table, instance interface{}) (string, error) {
	columns, values, err := getColumnsAndValues(table, instance)
	if err != nil {
		return "", err
	}
...
func (dialect *SQLDialect) Delete(table Table, where string, instance interface{}) (string, error) {
